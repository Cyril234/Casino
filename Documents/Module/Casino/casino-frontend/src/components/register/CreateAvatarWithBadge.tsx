...
type FocusedField = "avatarName" | "avatarDescription" | null;
...
export default function CreateAvatarWithBadge() {
  ...
  const onFocusField = (field: FocusedField) => {
  ...
  const onBlurField = () => {
    setTimeout(() => {
      ...
      if (active?.id !== "avatar-name" && active?.id !== "avatar-description") {
  ...
  const onKeyPress = (key: string) => {
    ...
    } else if (focusedField === "avatarDescription") {
  ...
  const ArrowSelector = ({
   ...
   return (
    <main className="create-avatar-page">
      ...
      <div
        className="create-avatar-wrapper"
        style={{
          display: "flex",
      ...
      >
        ...
        <form
          ...
          style={{ flex: "0 0 35%", display: "flex", flexDirection: "column", gap: "1rem" }}
        >
          <label className="form-label" htmlFor="avatar-name">
            Avatar-Name
          </label>
          <input
            id="avatar-name"
            ...
            onFocus={() => onFocusField("avatarName")}
            onBlur={onBlurField}
            required
            autoComplete="off"
          />

          <label className="form-label" htmlFor="avatar-description">
            Beschreibung
          </label>
          <input
            ...
            onFocus={() => onFocusField("avatarDescription")}
            onBlur={onBlurField}
            required
            autoComplete="off"
          />
